...
//   // פונקציה עזר להמרת נתונים מהשרת לפורמן הנדרש (אם צריך)
//   private transformToEnumItem(data: any): EnumItem[] {
//     if (Array.isArray(data)) {
//       // אם השרת מחזיר מערך של אובייקטים עם key/value
//       return data.map(item => ({
//         key: item.key || item.Key || item.id || item, // התאמה אפשרית לשמות שונים
//         value: item.value || item.Value || item.name || item // התאמה אפשרית
//       }));
//     } else if (typeof data === 'object' && data !== null) {
//       // אם השרת מחזיר אובייקט עם מפתחות וערכים
...
//   // מתודה גנרית לגישה ל-Enums נוספים
